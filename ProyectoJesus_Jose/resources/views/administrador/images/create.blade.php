    ...
    <div class="card-body">
        <form method="POST" action="{{ route('admin.images.store') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="mime_type" id="mime_type" class="form-control" >
            </div>
            <div class="mb-3">
                <label for="imageable_id" class="form-label">Imageable id</label>
                <input type="text" name="imageable_id" id="imageable_id" class="form-control" >
            </div>
            <div class="mb-3">
                <label for="imageable_type" class="form-label">Imageable type</label>
                <input type="text" name="imageable_type" id="imageable_type" class="form-control" >
            </div>
            <div class="mb-3">
