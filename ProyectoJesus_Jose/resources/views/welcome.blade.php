...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <header class="bg-blue-900 text-white shadow-lg">
        <div class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
            <h1 class="text-2xl font-bold tracking-wide">
                AUTO<span class="text-yellow-400">PREMIUM</span>
            </h1>

            <nav class="hidden md:flex space-x-8 font-medium">
                <a href="#" class="hover:text-yellow-400 transition">Inicio</a>
                <a href="#" class="hover:text-yellow-400 transition">Vehículos</a>
                <a href="#" class="hover:text-yellow-400 transition">Piezas</a>
                <a href="#" class="hover:text-yellow-400 transition">Nosotros</a>
                <a href="#" class="hover:text-yellow-400 transition">Contacto</a>
            </nav>

            <a href="#" class="bg-yellow-400 text-blue-900 px-5 py-2 rounded-lg font-semibold hover:bg-yellow-300 transition">
                Publicar
            </a>
        </div>
    </header>
    ...
    <!-- HERO SECTION -->
    <section class="bg-gradient-to-r from-blue-900 via-blue-800 to-blue-700 text-white py-24">
        <div class="max-w-7xl mx-auto px-6 grid md:grid-cols-2 items-center gap-12">
            ...
            <div>
                ...
                <p class="text-lg mb-8 text-blue-100">
                    Compra vehículos y piezas automotrices de calidad garantizada. 
                    Seguridad, confianza y los mejores precios del mercado.
                </p>

                <div class="flex gap-4">
                    <a href="#" class="bg-yellow-400 text-blue-900 px-6 py-3 rounded-lg font-semibold hover:bg-yellow-300 transition">
                        Ver Vehículos
                    </a>
                    <a href="#" class="border border-white px-6 py-3 rounded-lg hover:bg-white hover:text-blue-900 transition">
                        Explorar Piezas
                    </a>
                </div>
            </div>
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4">Automático · Gasolina · 15,000km</p>
                        <div class="flex justify-between items-center">
                            <span class="text-yellow-500 font-bold text-lg">$18,500</span>
                            <button class="bg-blue-900 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition">
                                Ver más
                            </button>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4">Manual · Deportivo · 8,000km</p>
                        <div class="flex justify-between items-center">
                ...
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-gray-600 mb-4">SUV · Automático · 5,000km</p>
                        <div class="flex justify-between items-center">
    ...
    <section class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-6 text-center">
            ...
            <div class="grid md:grid-cols-4 gap-6">
                ...
                <div class="bg-blue-900 text-white p-8 rounded-xl hover:bg-blue-800 transition">
    ...
    <section class="bg-blue-900 text-white py-16 text-center">
        ...
        <a href="#" class="bg-yellow-400 text-blue-900 px-8 py-3 rounded-lg font-semibold hover:bg-yellow-300 transition">
            Crear Cuenta
        </a>
    </section>
    ...
    <footer class="bg-gray-900 text-gray-400 py-10">
        <div class="max-w-7xl mx-auto px-6 text-center">
            <p>© 2026 AutoPremium. Todos los derechos reservados.</p>
        </div>
    </footer>
